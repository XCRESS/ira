...
export const ResultsView: React.FC<ResultsViewProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 backdrop-blur-sm flex items-center justify-center px-4 py-8 overflow-y-auto"
     style={{
      ...
      <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
       ...
       <button
        ...
        >
          ...
          >
            {isEligible ? "You Are SME IPO Ready" : "Eligibility Gaps Identified"}
          </h2>
...
>
  {isEligible ? "Get Free Assessment" : "Get Improvement Plan"}
