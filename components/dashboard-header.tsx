...
export function DashboardHeader({ user }: Props) {
  ...
  return (
    <header className="glass sticky top-0 z-40 flex h-16 items-center justify-between border-b border-foreground/10 px-6">
      {/* Breadcrumbs will be injected by pages */}
